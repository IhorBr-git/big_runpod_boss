...
# compatibility with the driver while still supporting RTX 5090 Blackwell arch.
# NOTE: cu130 requires a newer driver (>=CUDA 13.0) and will crash on CUDA 12.8 pods.
